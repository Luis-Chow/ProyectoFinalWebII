...
const AUDIT_ACTIONS = {
    ...
    addPersonCharge: 'insert',
    removePersonCharge: 'delete',
...
(async () => {
    try {
        ...
        const seeds = [
            ...
            ['model', 'seedMethodSendNotification'],
            ['model', 'seedMethodListProyectNotifications'],
            ['model', 'seedMethodGetMyNotifications'],
            ['model', 'seedMethodUpdateActivity'],
            ['model', 'seedMethodListActivityAssignees'],
            ['model', 'seedMethodRemoveActivityAssignee'],
            ['model', 'seedMethodListPersonCharges'],
            ['model', 'seedMethodAddPersonCharge'],
            ['model', 'seedMethodRemovePersonCharge'],
            ['model', 'seedMethodListAssignableMembers'],
            ...
            ['model', 'seedOptionNotificar'],
            ['model', 'seedOptionMisNotif'],
            ['model', 'seedOptionProyectStatus'],
            ...
            ['model', 'seedPermAdminListPersonCharges'],
            ['model', 'seedPermAdminAddPersonCharge'],
            ['model', 'seedPermAdminRemovePersonCharge'],
            ...
            ['model', 'seedUserLuis'],
            ['model', 'seedUserRonald'],
            ['model', 'seedUserJuan'],
            ['model', 'seedUserMaria'],
            ['model', 'seedUserProfileLuisAdmin'],
            ['model', 'seedUserProfileLuisLider'],
            ['model', 'seedUserProfileRonald'],
            ['model', 'seedUserProfileJuan'],
            ['model', 'seedUserProfileMaria'],
            ...
            ['model', 'syncPersonSeq'],
            ['model', 'seedPersonChargeLuis'],
            ['model', 'seedPersonChargeRonald'],
            ['model', 'seedPersonChargeRonald2'],
            ['model', 'seedPersonChargeJuan'],
            ['model', 'seedPersonChargeMaria'],
            ['model', 'seedPersonUserLuis'],
            ['model', 'seedPersonUserRonald'],
            ['model', 'seedPersonUserJuan'],
            ['model', 'seedPersonUserMaria'],

            // Datos de ejemplo del subsistema de proyectos: para poder DEMOSTRAR (no solo
            // crear en caliente) cada caso de uso apenas se levanta el servidor.
            ['model', 'seedProyectRRHH'],
            ['model', 'seedProyectMigracion'],
            ['model', 'seedProyectFacturacion'],
            ['model', 'seedProyectRoleRRHHLider'],
            ['model', 'seedProyectRoleRRHHDesarrollador'],
            ['model', 'seedProyectRoleRRHHDocumentista'],
            ['model', 'seedProyectRoleRRHHAnalista'],
            ['model', 'seedProyectRoleMigracionLider'],
            ['model', 'seedProyectRoleMigracionDesarrollador'],
            ['model', 'seedProyectRoleFacturacionLider'],
            ['model', 'seedProyectRoleFacturacionDocumentista'],
            ['model', 'seedProyectRoleFacturacionAnalista'],
            ['model', 'seedMemberRRHHLuis'],
            ['model', 'seedMemberRRHHRonald'],
            ['model', 'seedMemberRRHHMaria'],
            ['model', 'seedMemberRRHHJuan'],
            ['model', 'seedMemberMigracionLuis'],
            ['model', 'seedMemberMigracionRonald'],
            ['model', 'seedMemberFacturacionLuis'],
            ['model', 'seedMemberFacturacionMaria'],
            ['model', 'seedMemberFacturacionJuan'],
            ['model', 'seedActivityRRHHDiseno'],
            ['model', 'seedActivityRRHHManual'],
            ['model', 'seedActivityRRHHRequerimientos'],
            ['model', 'seedActivityMigracionServidores'],
            ['model', 'seedActivityMigracionBD'],
            ['model', 'seedActivityFacturacionDocumentacion'],
            ['model', 'seedActivityFacturacionImpuestos'],
            ['model', 'seedAssignRRHHDiseno'],
            ['model', 'seedAssignRRHHManual'],
            ['model', 'seedAssignRRHHRequerimientos'],
            ['model', 'seedAssignMigracionServidores'],
            ...
            ['model', 'seedReportFacturacionDocumentacion'],
            ['model', 'seedReportFacturacionImpuestos'],
            ['model', 'seedCompleteRRHHRequerimientos'],
            ['model', 'seedCompleteFacturacionDocumentacion'],
            ['model', 'seedCompleteFacturacionImpuestos'],
            ['model', 'seedNotifRRHH1'],
            ['model', 'seedNotifRRHH2'],
            ['model', 'seedNotifMigracion']
        ];
